...
<script lang="ts">
	...
	function handleSubmit() {
		...
		if (lower.includes('machine learning')) goto('/ml');
	}
</script>
...
<div class="flex min-h-screen flex-col items-center justify-center bg-[#151515] px-4 text-white">
	...
	<div class="flex flex-wrap justify-center gap-3">
		<button
			on:click={() => goto('/ml')}
			class="rounded-full bg-[#191919] px-4 py-2 text-xs text-[#5B8DF2] transition duration-300 ease-in-out hover:bg-[#1F1F1F]"
		>
